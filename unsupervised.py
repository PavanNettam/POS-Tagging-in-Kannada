        ...
        if i > 3:
            if tokens[i - 1] in feature_words:
                feature_vectors[unique_words.index(tokens[i])][
                    len(feature_words) + feature_words.index(tokens[i - 1])] += 1
            if tokens[i - 2] in feature_words:
                feature_vectors[unique_words.index(tokens[i])][
                    len(feature_words) + feature_words.index(tokens[i - 2])] += 1
            if tokens[i - 3] in feature_words:
                feature_vectors[unique_words.index(tokens[i])][
                    len(feature_words) + feature_words.index(tokens[i - 3])] += 1
            if tokens[i - 4] in feature_words:
                feature_vectors[unique_words.index(tokens[i])][
                    len(feature_words) + feature_words.index(tokens[i - 4])] += 1
